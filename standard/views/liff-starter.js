...
window.onload = function() {
    ...
    const defaultLiffId = "1653795234-0qEDExaq";   // change the default LIFF value if you are not using a node server
...
function displayLiffData() {
    ...
    liff.getProfile().then(function (profile) {
        ...
        //window.alert(liff.getDecodedIDToken().email);
        //$('#IdToken').val(liff.getDecodedIDToken().email);
        $('#IdToken').val(liff.getDecodedIDToken().email);
